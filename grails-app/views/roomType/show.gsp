...
<html>
    ...
    <body>
        ...
        <div id="show-roomType" class="content scaffold-show" role="main">
            ...
            <f:display bean="roomType" />
            <g:form resource="${this.roomType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.roomType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
